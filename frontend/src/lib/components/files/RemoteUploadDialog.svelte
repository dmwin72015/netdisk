...
>
  {#if done}
    ...
    <div
      class="flex items-center justify-end gap-2 border-t border-line-soft px-5 py-3 -mx-5 -mb-4"
    >
      <button
        type="button"
  ...
  {:else}
    ...
    <div
      class="flex items-center justify-end gap-2 border-t border-line-soft px-5 py-3 -mx-5 -mb-4 mt-2"
    >
      <button
        type="button"
        class="rounded-lg border border-line bg-surface px-4 py-2 text-sm text-ink-2 transition-colors hover:bg-surface-sunken"
