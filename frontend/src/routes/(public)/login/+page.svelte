			...
			<div class="auth-card rounded-lg border border-white/80 bg-white/90 p-6 shadow-2xl shadow-slate-300/50 backdrop-blur-xl sm:p-8">
				...
				<div class="mt-6 space-y-3">
					<button
						...
						disabled={oauthBusy}
						class="flex w-full items-center justify-center gap-2 rounded-lg border border-slate-200 bg-white px-4 py-3 text-sm font-medium text-slate-700 shadow-sm transition hover:bg-slate-50 disabled:cursor-not-allowed disabled:opacity-60"
					>
						{#if oauthBusy}
