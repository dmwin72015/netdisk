...
func TestMapError(t *testing.T) {
	tests := []struct {
		...
		{name: "invalid credentials", err: model.ErrInvalidCredentials, status: 401, code: 1013, msg: "invalid credentials"},
		...
		{name: "wrapped invalid credentials", err: fmt.Errorf("wrap: %w", model.ErrInvalidCredentials), status: 401, code: 1013, msg: "invalid credentials"},
