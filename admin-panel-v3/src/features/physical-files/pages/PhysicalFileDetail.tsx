...
export default function PhysicalFileDetailPage() {
  ...
  return (
    ...
    >
      <Row gutter={16}>
        <Col span={6}>
          <Card><Statistic title="总上传数" value={totalUploads} /></Card>
        </Col>
        <Col span={6}>
          <Card><Statistic title="独立用户数" value={uniqueUsers} /></Card>
        </Col>
        <Col span={6}>
          <Card><Statistic title="总大小" value={formatBytes(totalSize)} /></Card>
        </Col>
        <Col span={6}>
          <Card><Statistic title="引用次数" value={physicalFile.userFileCount + physicalFile.mediaItemCount} /></Card>
        </Col>
      </Row>

      <Card title="物理文件信息" className="mt-6!">
      ...
      {userFiles.length > 0 && (
        <Card title="用户上传记录" className="mt-6!">
